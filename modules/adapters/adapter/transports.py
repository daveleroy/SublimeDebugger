...
class Process:
	@staticmethod
	async def check_output(command: list[str], cwd: str|None = None, stderr: Any = None) -> bytes:
		return await core.run_in_executor(lambda: subprocess.check_output(command, cwd=cwd, stderr=stderr))
